...
int main()
{
	...
	cout << "Размер переменной name в байтах: " << sizeof(char)*5 << "\n" << endl;
	cout << "+ Адреса байтов переменной name: " << "\n" << endl;

	fout << "Выводим элементы переменной структуры pacien1.name[]" << endl;
	fout << "Размер переменной name[] в байтах: " << sizeof(char)*5 << "\n" << endl;
	...
	cout << "Размер переменной surname[] в байтах: " << sizeof(char)*5 << "\n" << endl;
	cout << "+ Адреса байтов переменной surname[]: " << "\n" << endl;

	fout << "Выводим элементы переменной структуры pacien1.surname[]" << endl;
	fout << "Размер переменной surname[] в байтах: " << sizeof(char)*5 << "\n" << endl;
	...
	cout << "Размер переменной age в байтах: " << sizeof(int) << "\n" << endl;
	cout << "+ Адреса байтов переменной age: " << "\n" << endl;

	fout << "Выводим элементы переменной структуры pacien1.age" << endl;
	fout << "Размер переменной age в байтах: " << sizeof(int) << "\n" << endl;
	...
	cout << "Размер переменной gender в байтах: " << sizeof(int) << "\n" << endl;
	cout << "+ Адреса байтов переменной gender: " << "\n" << endl;

	fout << "Выводим элементы переменной структуры pacien1.gender" << endl;
	fout << "Размер переменной gender в байтах: " << sizeof(int) << "\n" << endl;
	...
	cout << "Размер переменной health в байтах: " << sizeof(double) << "\n" << endl;
	cout << "+ Адреса байтов переменной health: " << "\n" << endl;

	fout << "Выводим элементы переменной структуры pacien1.health" << endl;
	fout << "Размер переменной health в байтах: " << sizeof(double) << "\n" << endl;
...
//////////////////////////////////////////////////////////////////////////
	...
	cout << "Размер переменной gender в байтах: " << sizeof(char) << "\n" << endl;
	cout << "+ Адреса байтов переменной gender: " << "\n" << endl;

	fout << "Выводим элементы переменной структуры pacien3.gender" << endl;
	fout << "Размер переменной gender в байтах: " << sizeof(char) << "\n" << endl;
	fout << "+ Адреса байтов переменной gender: " << "\n" << endl;
